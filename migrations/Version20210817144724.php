 ...
 */
final class Version20210817144724 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE catalog (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) DEFAULT NULL, code VARCHAR(60) DEFAULT NULL, needs_parcel TINYINT(1) DEFAULT NULL, center LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', min_lat DOUBLE PRECISION DEFAULT NULL, max_lat DOUBLE PRECISION DEFAULT NULL, min_lng DOUBLE PRECISION DEFAULT NULL, max_lng DOUBLE PRECISION DEFAULT NULL, is_default TINYINT(1) DEFAULT NULL, zoom INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
