...
class Meta
{
     ...
     * @Groups({"metas_read", "users_read", "user_write", "relaypoints_read", "relaypoint_write", "orders_read", "order_write", "tourings_read", "platform_write", "platforms_read", "supervisors_read", "stores_read", "store_write", "sellers_read", "seller_write", "sales_read", "traceabilities_read", "packages_read"})
     */
    private $id;

    /**
     * @ORM\Column(type="string", length=255, nullable=true)
     * @Groups({"metas_read", "users_read", "user_write", "relaypoints_read", "relaypoint_write", "orders_read", "order_write", "tourings_read", "platform_write", "platforms_read", "supervisors_read", "stores_read", "store_write", "sellers_read", "seller_write", "sales_read", "packages_read"})
