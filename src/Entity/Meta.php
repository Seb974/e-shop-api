...
class Meta
{
     ...
     */
    private static $domain = 'https://localhost:8000';

    /**
     * @ORM\Id
     * @ORM\GeneratedValue
     * @ORM\Column(type="integer")
     * @Groups({"metas_read", "users_read", "user_write", "relaypoints_read", "relaypoint_write", "orders_read", "order_write", "tourings_read"})
     */
    private $id;
