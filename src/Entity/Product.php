...
class Product
{
     ...
     * @Groups({"products_read", "orders_read", "tourings_read", "provisions_read", "goods_read", "heroes_read", "homepages_read", "countdowns_read", "banners_read", "purchases_read", "sales_read", "stocks_read", "traceabilities_read", "batches_read", "banners_read", "countdowns_read", "heroes_read", "homepages_read", "losts_read"})
     */
    private $id;

    /**
     * @ORM\Column(type="string", length=120, nullable=true)
     * @Groups({"products_read", "product_write", "orders_read", "tourings_read", "provisions_read", "goods_read", "heroes_read", "homepages_read", "countdowns_read", "banners_read", "purchases_read", "sales_read", "stocks_read", "traceabilities_read", "batches_read", "banners_read", "countdowns_read", "heroes_read", "homepages_read", "losts_read"})
     ...
     * @Groups({"products_read", "product_write", "traceabilities_read", "batches_read", "losts_read"})
     */
    private $sku;
     ...
     * @Groups({"products_read", "product_write", "orders_read", "tourings_read", "provisions_read", "goods_read", "heroes_read", "homepages_read", "countdowns_read", "banners_read", "purchases_read", "sales_read", "stocks_read", "batches_read", "traceabilities_read", "banners_read", "countdowns_read", "heroes_read", "homepages_read", "losts_read"})
     */
    private $unit;

    /**
     * @ORM\Column(type="float", nullable=true)
     * @Groups({"products_read", "product_write", "orders_read", "purchases_read", "sales_read", "losts_read"})
     */
    private $weight;
    ...
    /**
     * @ORM\Column(type="boolean", nullable=true)
     * @Groups({"products_read", "product_write", "orders_read", "admin:orders_read", "provisions_read", "purchases_read", "sales_read", "tourings_read", "losts_read"})
     */
